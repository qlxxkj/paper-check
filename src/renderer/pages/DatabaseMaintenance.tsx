...
const DatabaseMaintenance: React.FC = () => {
    ...
    useEffect(() => {
        ...
        window.electronAPI.onImportProgress(handler);
    }, []);
    ...
    const handleBatchImport = async () => {
        const openResult = await window.electronAPI.openFileDialog({
        ...
        try {
            const res = await window.electronAPI.importLegacyFolder(folderPath);
            setImportResult({
            ...
            <div style={{
                ...
                <button
                    onClick={async () => {
                        ...
                        try {
                            const res = await window.electronAPI.rebuildNGramIndex();
